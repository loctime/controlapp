  ...
  return (
    <main className="bg-[rgb(247,243,237)] text-[rgb(18,24,37)]">
      <section className="relative overflow-hidden border-b border-[rgba(34,30,24,0.1)]">
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-14 px-6 pb-20 pt-16 md:px-10 lg:grid-cols-[minmax(0,1.02fr)_minmax(380px,0.98fr)] lg:px-12 lg:pb-24 lg:pt-24">
          <div className="max-w-3xl">
            <p className="font-mono text-xs uppercase tracking-[0.34em] text-[rgb(102,82,60)]">ControlApps</p>
            <h1 className="font-display mt-6 max-w-4xl text-[clamp(4rem,8vw,6.7rem)] font-semibold leading-[0.86] tracking-[-0.06em] text-[rgb(18,24,37)]">
              Software a medida para ordenar operación real con más criterio y menos fricción.
            </h1>
            <p className="mt-8 max-w-2xl text-lg font-medium leading-8 text-[rgb(56,60,70)] md:text-xl">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a
                href="#contacto"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-[rgba(24,30,43,0.14)] bg-[rgb(20,29,46)] px-6 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-[rgb(28,38,58)]"
              >
              ...
              <Link
                href="/metodologia"
                className="inline-flex items-center justify-center rounded-full border border-[rgba(34,30,24,0.12)] bg-[rgba(255,255,255,0.62)] px-6 py-3.5 text-sm font-semibold text-[rgb(28,34,47)] transition-colors hover:bg-[rgba(255,255,255,0.82)]"
              >
                Ver metodología
              </Link>
            </div>
            ...
            <div className="mt-14 grid gap-4 sm:grid-cols-3">
              {siteContent.heroStats.map((stat) => (
                <div key={stat.label} className="border-l border-[rgba(34,30,24,0.14)] pl-4">
                  <p className="font-mono text-[11px] uppercase tracking-[0.28em] text-[rgb(102,82,60)]">{stat.label}</p>
                  <p className="mt-3 text-2xl font-semibold tracking-[-0.05em] text-[rgb(18,24,37)]">{stat.value}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative">
            <div className="rounded-[2rem] border border-[rgba(214,203,191,0.2)] bg-[linear-gradient(180deg,_rgb(22,31,47),_rgb(16,23,36))] p-5 text-white shadow-[0_28px_70px_rgba(8,12,20,0.24)]">
              <div className="rounded-[1.7rem] border border-[rgba(214,203,191,0.14)] bg-[linear-gradient(180deg,_rgba(255,255,255,0.05),_rgba(255,255,255,0.02))] p-6">
                <div className="flex items-start justify-between gap-4 border-b border-[rgba(214,203,191,0.12)] pb-5">
                  <div>
                    <p className="font-mono text-[11px] uppercase tracking-[0.3em] text-[rgba(218,204,188,0.74)]">
                      Arquitectura operativa
                    </p>
                    <p className="font-display mt-3 text-[2.5rem] font-semibold leading-none tracking-[-0.04em] text-[rgb(248,246,241)]">
                      Menos parche.
                      <br />
                      Más sistema.
                    </p>
                  </div>
                  <div className="rounded-full border border-[rgba(214,203,191,0.16)] px-4 py-2 font-mono text-[11px] uppercase tracking-[0.24em] text-[rgba(229,220,208,0.74)]">
                    Diagnóstico + build
                  </div>
                </div>
                ...
                <div className="mt-6 space-y-4">
                  {heroCards.map((card, index) => (
                    <div
                      key={card.title}
                      className="grid gap-4 rounded-[1.45rem] border border-[rgba(214,203,191,0.1)] bg-[rgba(255,255,255,0.035)] p-5 md:grid-cols-[32px_minmax(0,1fr)]"
                    >
                      <span className="font-mono text-[11px] uppercase tracking-[0.24em] text-[rgba(218,204,188,0.7)]">
                        0{index + 1}
                      </span>
                      <div>
                        <p className="text-base font-semibold text-[rgb(248,246,241)]">{card.title}</p>
                        <p className="mt-2 text-sm leading-6 text-[rgba(229,224,216,0.82)]">{card.description}</p>
                      </div>
                    </div>
                  ))}
                </div>

                <div className="mt-6 grid gap-4 border-t border-[rgba(214,203,191,0.12)] pt-5 sm:grid-cols-3">
                  {siteContent.heroSignals.map((signal) => (
                    <div key={signal.label}>
                      <p className="font-mono text-[11px] uppercase tracking-[0.26em] text-[rgba(218,204,188,0.66)]">
                        {signal.label}
                      </p>
      ...
      <section id="empresa" className="mx-auto w-full max-w-7xl px-6 py-20 md:px-10 lg:px-12">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:gap-16">
          <div>
            ...
            <h2 className="font-display mt-5 text-[clamp(3rem,5vw,4.4rem)] font-semibold leading-[0.94] tracking-[-0.05em] text-[rgb(18,24,37)]">
              Una firma de software enfocada en resolver trabajo operativo que hoy se sostiene con esfuerzo excesivo.
            </h2>
          </div>
          <div className="space-y-6 border-l border-[rgba(34,30,24,0.12)] pl-6 text-lg font-medium leading-8 text-[rgb(56,60,70)] lg:pl-10">
      ...
      <section id="problemas" className="border-y border-[rgba(34,30,24,0.12)] bg-[rgba(255,255,255,0.48)]">
        <div className="mx-auto grid w-full max-w-7xl gap-12 px-6 py-20 md:px-10 lg:grid-cols-[0.84fr_1.16fr] lg:px-12">
          <div>
            <p className="font-mono text-xs uppercase tracking-[0.3em] text-[rgb(102,82,60)]">Problemas que resolvemos</p>
            <h2 className="font-display mt-5 text-[clamp(3rem,5vw,4.2rem)] font-semibold leading-[0.94] tracking-[-0.05em] text-[rgb(18,24,37)]">
          ...
          <div className="divide-y divide-[rgba(34,30,24,0.12)] border-y border-[rgba(34,30,24,0.12)]">
            {siteContent.painPoints.map((item) => {
              ...
              return (
                <div key={item.title} className="grid gap-4 py-6 md:grid-cols-[56px_minmax(0,1fr)]">
      ...
      <section id="soluciones" className="mx-auto w-full max-w-7xl px-6 py-20 md:px-10 lg:px-12">
        <div className="flex flex-col gap-5 lg:max-w-3xl">
          ...
          <h2 className="font-display text-[clamp(3rem,5vw,4.2rem)] font-semibold leading-[0.94] tracking-[-0.05em] text-[rgb(18,24,37)]">
            Sistemas hechos para la lógica real de cada organización.
          </h2>
          <p className="text-lg font-medium leading-8 text-[rgb(56,60,70)]">
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-2">
          {siteContent.services.map((service) => {
            ...
            return (
              <article
                key={service.title}
                className="rounded-[1.9rem] border border-[rgba(34,30,24,0.12)] bg-[rgba(255,255,255,0.68)] p-7 shadow-[0_18px_40px_rgba(20,24,31,0.06)]"
              >
                <div className="flex items-start justify-between gap-5">
                  ...
                  <div className="font-mono text-[11px] uppercase tracking-[0.24em] text-[rgb(102,82,60)]">Sistema específico</div>
                </div>
                <h3 className="font-display mt-6 text-[2.35rem] font-semibold leading-none tracking-[-0.04em] text-[rgb(18,24,37)]">
                  {service.title}
                </h3>
                <p className="mt-4 text-base font-medium leading-7 text-[rgb(56,60,70)]">{service.description}</p>
                <ul className="mt-6 grid gap-3 border-t border-[rgba(34,30,24,0.1)] pt-5 text-sm leading-6 text-[rgb(39,45,57)] sm:grid-cols-2">
        ...
        <div className="mx-auto w-full max-w-7xl px-6 py-20 md:px-10 lg:px-12">
          <div className="grid gap-10 lg:grid-cols-[0.88fr_1.12fr]">
            <div>
              ...
              <h2 className="font-display mt-5 text-[clamp(3rem,5vw,4.2rem)] font-semibold leading-[0.94] tracking-[-0.05em]">
                Entendemos la operación antes de tocar una línea de software.
              </h2>
              <p className="mt-6 max-w-xl text-lg leading-8 text-[rgba(239,242,247,0.86)]">
            ...
            <div className="space-y-4">
              {siteContent.process.map((step, index) => {
                ...
                return (
                  <div
                    key={step.title}
                    className="grid gap-4 rounded-[1.7rem] border border-[rgba(214,203,191,0.12)] bg-[rgba(255,255,255,0.04)] p-6 md:grid-cols-[36px_52px_minmax(0,1fr)]"
                  >
                    <div className="font-mono text-xs uppercase tracking-[0.28em] text-[rgba(207,188,165,0.74)]">
                      0{index + 1}
                    </div>
          ...
          <div className="mt-12">
            <Link
              href="/metodologia"
              className="inline-flex items-center gap-2 rounded-full border border-[rgba(207,188,165,0.2)] bg-[rgb(241,235,226)] px-5 py-3 text-sm font-semibold text-[rgb(20,29,46)] transition-colors hover:bg-[rgb(246,242,236)]"
            >
        ...
        <div className="grid gap-5 lg:grid-cols-3">
          {siteContent.differentiators.map((item) => {
            ...
            return (
              <article
                key={item.title}
                className="rounded-[1.8rem] border border-[rgba(34,30,24,0.12)] bg-[rgba(255,255,255,0.58)] p-7"
              >
                ...
                <h3 className="font-display mt-6 text-[2.2rem] font-semibold leading-none tracking-[-0.04em] text-[rgb(18,24,37)]">
                  {item.title}
                </h3>
      ...
      <section id="contacto" className="bg-[rgb(20,29,46)]">
        <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-20 md:px-10 lg:grid-cols-[0.88fr_1.12fr] lg:px-12">
          <div className="max-w-xl text-white">
            ...
            <p className="mt-6 text-lg leading-8 text-[rgba(243,245,249,0.9)]">
