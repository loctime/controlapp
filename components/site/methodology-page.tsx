  ...
  return (
    <main className="bg-[rgb(250,248,244)] text-[rgb(15,23,42)]">
      <section className="mx-auto w-full max-w-5xl px-6 py-16 md:px-10 lg:py-24">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm font-medium text-[rgb(82,94,118)] transition-colors hover:text-[rgb(22,35,62)]"
        >
        ...
        <div className="mt-10 max-w-4xl">
          <p className="font-mono text-xs uppercase tracking-[0.32em] text-[rgb(94,109,136)]">Metodología</p>
          ...
          <p className="mt-8 text-lg leading-8 text-[rgb(82,94,118)]">
      ...
      <section className="mx-auto w-full max-w-5xl px-6 pb-20 md:px-10">
        <div className="grid gap-5">
          {siteContent.processDetailed.map((step, index) => (
            <article
              key={step.title}
              className="rounded-[1.9rem] border border-[rgba(18,26,44,0.08)] bg-white p-8 shadow-[0_18px_55px_rgba(15,23,42,0.05)]"
            >
              ...
              <p className="mt-5 text-lg leading-8 text-[rgb(82,94,118)]">{step.description}</p>
            </article>
          ))}
        </div>

        <div className="mt-16 rounded-[2rem] bg-[rgb(20,31,54)] p-8 text-white shadow-[0_30px_80px_rgba(15,23,42,0.2)] md:p-10">
          <h2 className="text-3xl font-semibold tracking-[-0.05em]">El objetivo final es simple: menos fricción y más control.</h2>
          <p className="mt-4 max-w-2xl text-lg leading-8 text-[rgba(224,230,240,0.76)]">
          ...
          <a
            href="/#contacto"
            className="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-[rgb(22,35,62)] transition-transform hover:-translate-y-0.5"
          >
            Contanos tu proceso
