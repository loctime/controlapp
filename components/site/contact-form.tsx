...
export function ContactForm({ email }: ContactFormProps) {
  ...
  return (
    <div className="rounded-[2rem] border border-[rgba(18,26,44,0.12)] bg-white p-6 shadow-[0_24px_80px_rgba(15,23,42,0.12)] md:p-8">
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-[rgb(94,109,136)]">
            Contacto
          </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <Input
              ...
              name="name"
              required
              className="h-12 rounded-2xl border-[rgba(18,26,44,0.14)] px-4 text-[15px] text-[rgb(15,23,42)]"
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            name="challenge"
            required
            className="min-h-36 rounded-[1.5rem] border-[rgba(18,26,44,0.14)] px-4 py-3 text-[15px] text-[rgb(15,23,42)]"
        ...
        <div className="flex flex-col gap-3 border-t border-[rgba(18,26,44,0.08)] pt-5 sm:flex-row sm:items-center sm:justify-between">
          <p className="max-w-md text-sm leading-6 text-[rgb(82,94,118)]">
            El formulario prepara un correo con tu contexto para iniciar la conversación de forma directa.
          </p>
          <Button
            type="submit"
            className="h-12 rounded-full bg-[rgb(22,35,62)] px-6 text-sm font-semibold tracking-[0.02em] text-white hover:bg-[rgb(31,48,83)]"
          >
