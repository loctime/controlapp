...
export const Clients = memo(() => {
  return (
    <section id="clientes" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white">
      ...
      <div className="absolute bottom-20 right-20 w-72 h-72 bg-cyan-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float-delayed"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <motion.span 
            ...
            viewport={{ once: true }}
            className="inline-block text-blue-300 font-semibold text-sm uppercase tracking-wider mb-6 px-4 py-2 bg-white/10 rounded-full backdrop-blur-sm"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="text-center glass-effect rounded-3xl p-8 border-2 border-white/10 hover:border-blue-300/50 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/30"
            >
              <motion.div 
                className="text-5xl lg:text-6xl font-extrabold bg-gradient-to-br from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-3"
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
                viewport={{ once: true }}
        ...
        >
          <div className="glass-effect rounded-3xl p-10 lg:p-14 border-2 border-white/10 shadow-2xl relative overflow-hidden">
            ...
            <div className="absolute top-8 left-8 text-9xl font-serif text-blue-500/20 leading-none">"</div>
            
            <div className="flex flex-col md:flex-row items-start gap-8 relative z-10">
              <motion.div 
                className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 flex-shrink-0 shadow-2xl"
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="h-12 w-1 bg-gradient-to-b from-blue-500 to-cyan-500 rounded-full"></div>
                  <div>
